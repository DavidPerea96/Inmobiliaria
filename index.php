...
<!--- Body --->
<div class="container-fluid" style="margin-top:55px; background: linear-gradient(to bottom, pink, white);">
  <div class="row justify-content-center" style="margin-top: 200px; margin-bottom: 60px;">
    <h1 class="display-1" style="font-family: didot;">Your Snail House</h1>
  </div>
</div>
  <div class="container">
